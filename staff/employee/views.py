...
def employee_list(request):
    ...
    staff5 = Employee.objects.filter(level=5) # это все раб с уровнем 5
    for i in staff5:
    ...
    context = {"employee_list": employees, 'staff5': staff5, 'personal': personal, 'people': people, 'numeros': numeros, 'emp_es': emp_es}
